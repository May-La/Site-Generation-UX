...
<p>
Pour vérifier la cohérence intra module nous avons utilisé le coefficient alpha de Chronbach. Ce coefficient est utilisé en recherche pour estimer la fidélité d’une échelle, sa valeur est comprise entre 0 et 1. Plus les réponses aux items que l’on a choisi d’observer sont corrélés, plus sa valeur est élevée. Ainsi, on estime qu’une valeur supérieure à 0,70 est suffisante pour montrer une corrélation. Nous avons décidé de calculer le coefficient (noté ⍺) pour chacun des modules car ces derniers mesurent des choses différentes. Nous l’avons calculé conformément à la formule suivante : 
</p>
<p class="middle">
⍺ = (k/(k-1))*(1-(Si/St))
</p>
<ul>
<li>k est le nombre d’items dans le module.</li>
<li>Si est la somme des variances des scores obtenues pour chaque item.</li>
<li>St est la variance des sommes des scores obtenues par chaque participant.</li>
</ul>
<p>
...
<br>
<p>
On remarque que le labyrinthe “simple” semble avoir été plus facile d'utilisation selon les réponses à l'échelle: 5/12 tout à fait d’accord, et 4/12 d’accord ce qui fait 9/12 c’est à dire 75% des enfants ayant une réponse positive. De plus, il n'y a pas de réponses négatives ( d’accord ou pas d’accord), seulement un enfant neutre.
</p>
<p>
Cependant il y a 2 élèves qui n’ont pas à la question. Ceci peut s’expliquer par le fait que la question était la première sur la page et était trop proche des consignes en haut. 
</p>
<p>
On peut aussi observer que les labyrinthes “espace” et “citrouille” ont reçu eu des résultats négatifs ( ⅛ des enfant pour chaque labyrinthe) ce qui s’explique par la complexité plus élevées des labyrinthe : 
    </p>
<p>
...
<p>
Donc d’après l’échelle, le graphisme du labyrinthe importe peu sur l’envie d’y jouer.
</p>
<p>
En discutant avec les participants après le passage du test, on a pu entendre que les enfants avaient envie de faire ces labyrinthes, non pas parce qu’ils étaient jolis mais plutôt parce que le concept de labyrinthe est amusant en général. 
</p>
<p>
