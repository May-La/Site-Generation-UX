...
<body>
    <br>
    <h1>Protocole de test pour les enseignants</h1>
    <br>
    <p>
        Dans le cadre de notre projet, nous avons eu l'occasion d'être en contact avec des professeurs et, pour savoir si nous étions sur la bonne piste pour l'adaptation, 
        avons confectionné un questionnaire que nous leur avons ensuite envoyé. L'objectif de ce questionnaire était de savoir ce que les professeurs pensaient de l'échelle MeCue si on la faisait passer telle quelle à des enfants puis de proposer une adaptation.
    </p>
    <br>
    ...
    <br>
    <p>
        Comme on peut le voir, il est arrivé que les enseignants soient en désacord sur des affirmations. 
        Malheureusement, la façon dont nous avons fait le questionnaire ne nous permettait pas d'en savoir plus.
    </p>
